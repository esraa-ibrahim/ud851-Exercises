...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY = "TEXT_VIEW";
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String tvDisplay = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, tvDisplay);
    }
