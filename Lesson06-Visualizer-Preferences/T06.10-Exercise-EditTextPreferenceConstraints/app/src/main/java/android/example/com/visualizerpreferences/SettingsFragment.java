...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        Preference etPref = findPreference(getString(R.string.pref_size_key));
        etPref.setOnPreferenceChangeListener(this);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        Toast error = Toast.makeText(getActivity(), "Please enter number between 0.1 and 3", Toast.LENGTH_SHORT);
